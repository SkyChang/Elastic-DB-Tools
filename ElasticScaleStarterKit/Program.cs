...
namespace ElasticScaleStarterKit
{
    internal class Program
    {
        ...
        /// <summary>
        /// 建立 shard map manager, 建立 shard map, 建立 shard
        ...
        private static void CreateShardMapManagerAndShard()
        {
            ...
            // 建立提供給 split-merge service 的 schema info，以利可以轉移資料 ( 後續才會建立 )
            CreateSchemaInfo(shardMap.Name);

            // 假如找不到 Shard ，則增加兩個 一個為 0 ~100 一個為 100 ~ 200 
